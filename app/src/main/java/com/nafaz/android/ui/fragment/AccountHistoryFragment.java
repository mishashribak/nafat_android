...
//    private static final String ARG_COLUMN_COUNT = "column-count";
    ...
    public static AccountHistoryFragment newInstance(/*int columnCount*/) {
        AccountHistoryFragment fragment = new AccountHistoryFragment();
...
//        }
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, ViewGroup container,
        ...
        if (view instanceof RecyclerView) {
            ...
            recyclerView.setAdapter(new AccountHistoryAdapter(new ArrayList<>(), mListener));
        }
        return view;
    }
    ...
    public interface OnListFragmentInteractionListener {
        ...
        void onListFragmentInteraction(AccountHistory item);
    }
}
