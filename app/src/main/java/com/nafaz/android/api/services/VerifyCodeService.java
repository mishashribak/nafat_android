...
public class VerifyCodeService {
    ...
    private static final String TAG = VerifyCodeService.class.getSimpleName();

    public void start(CheckOtpRequest request, final ApiCallback callback) {

        final APIs apIs = APIBulldozer.createAPI(APIs.class);

        apIs.CheckOtp(request)
