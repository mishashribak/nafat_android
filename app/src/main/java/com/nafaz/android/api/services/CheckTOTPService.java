...
public class CheckTOTPService {

    private static final String TAG = CheckTOTPService.class.getSimpleName();

    public void start(CheckTOTPRequest request, final ApiCallback callback) {

        final APIs apIs = APIBulldozer.createAPI(APIs.class);

        apIs.checkTOTP(request)
