...
public class CheckFaceService {

    private static final String TAG = CheckFaceService.class.getSimpleName();

    public void start(CheckFaceRequest request, final ApiCallback callback) {

        final APIs apIs = APIBulldozer.createAPI(APIs.class);

        apIs.checkFace(request)
