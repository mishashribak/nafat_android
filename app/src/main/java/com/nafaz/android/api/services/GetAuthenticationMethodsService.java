...
public class GetAuthenticationMethodsService {

    private static final String TAG = GetAuthenticationMethodsService.class.getSimpleName();

    public void start(BigInteger personId, final ApiCallback callback) {

        final APIs apIs = APIBulldozer.createAPI(APIs.class);

        apIs.getAuthenticationMethods(personId)
