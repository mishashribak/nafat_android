...
public class ConfirmMobileService {

    private static final String TAG = ConfirmMobileService.class.getSimpleName();

    public void start(ConfirmMobileRequest request, final ApiCallback callback) {

        final APIs apIs = APIBulldozer.createAPI(APIs.class);

        apIs.confirmMobile(request)
